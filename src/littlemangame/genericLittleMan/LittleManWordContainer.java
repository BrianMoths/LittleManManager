...
public enum LittleManWordContainer {
     ...
     */
    NOTEBOOK_PAGE_SHEET(ComputerLocation.INSTRUCTION_POINTER, new WordContainerGetter() {
        @Override
     ...
     * the worksheet
     */
    WORKSHEET(ComputerLocation.REGISTER, new WordContainerGetter() {
        @Override
        public WordContainer getWordContainer(GenericLittleManData<?> littleManData) {
     ...
     */
    REMEMBERED_NOTEBOOK_PAGE(ComputerLocation.REMEMBERED_MEMORY, new WordContainerInterface() {
    ...
    private LittleManWordContainer(ComputerLocation locationForInstruction, WordContainerInterface wordContainerInterface) {
