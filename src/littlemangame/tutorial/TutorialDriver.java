...
public class TutorialDriver {
    ...
    static private final String OUTPUT_TEN_TEXT = "Now that the little man has written 10 on the worksheet we are ready to call the output instruction. Set the word on page 06 of the notebook to 20.";
